...
1. PrevalentTaxaListing.R generates lists of 80% prevalent bacterial (16S) and fungal taxa for the different location-year trials using the ps.filt.RDS and ps.q20.trunc200.RDS phyloseq objects for 16S and ITS data, respectively.
